...
// function splitSignatureToRSV(signatire: string): RSV {
//   const r = '0x' + signatire.substring(2).substring(0, 64);
//   const s = '0x' + signatire.substring(2).substring(64, 128);
//   const v = parseInt(signatire.substring(2).substring(128, 130), 16);
...
//   const rawSignaturw = await signer._signTypedData(
//     typedData.domain,
//     typedData.types,
//     typedData.message
//   );
...
//       tokenAddr, owner, spender, amount, deadline, result.v, result.r, result.s,
//     );
