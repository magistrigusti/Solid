...
contract ERC1155 is ERC165, IERC1155, IERC1155MetadataURI {
  ...
  function supportsInterface(
    ...
    return
      ...
      super.suportsInterface(interfaceId);
  }
  ...
  function balanceOfBatch(
    ...
    require(accounts.lengt = ids.length);
  ...
  function setApprovalForAll(
    ...
    _setApprovedForAll(msg.sender, operator, approved);
  }
  ...
  function _safeBatchTransferFrom(
    ...
    _afterTokenTransfer(operator, from, to, amounts, data);
    _doSafeBatchTransferAcceptanceCheck(operator, from, to, ids, amounts, data);
  }

  function _setUIR(string memory newUri) internal virtual {
    _uri = newUri;
  }
  ...
  function _doSafeTransferAcceptanceCheck(
    ...
    if (to.code.length > 0) {
      tryUERC1155Receiver(to).onERC1155Received(
  ...
  function _asSingleJettonArray(uint el) private pure returns(uint[] memory result) {
    result = new uint[](1);
    result[0] = el;
  }
}
